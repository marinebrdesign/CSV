    ...
    <div class="overlay">
      <div class="modale card">
        ...
        <div class="cercle_h3">
          ...
          <div class="h3_texte"><h3 id="h_modale_acheter">{{livre.auteur_titre_livre}}</h3></div>
        </div>
        <p id="informations" v-html="livre.informations_livre"></p>
        <p id="isbn" v-html="livre.ISBN_livre"></p>
        <div class="a_cote">
          <div class="img_acheter">
            <img :src="livre.image_livre.url" alt="livre.image_livre">
          </div>
          <p v-html="livre.resume_livre"></p>
        </div>
